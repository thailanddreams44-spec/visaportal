...
const R2_ACCOUNT_ID = process.env.R2_ACCOUNT_ID || "3e6d434d8424565348aeed8b0adb113e";
const R2_ACCESS_KEY_ID = process.env.R2_ACCESS_KEY_ID || "ee7f9d024a252eacabe55eaedc7f763c";
const R2_SECRET_ACCESS_KEY = process.env.R2_SECRET_ACCESS_KEY || "edd2b4a476eb60f9d13efa9e389cb1554c19c245b343ad9b0bc3e4a6d9c12a54";
const R2_BUCKET_NAME = process.env.R2_BUCKET_NAME || "visaportal";
...
const SERVICE_ACCOUNT_PATH = process.env.SERVICE_ACCOUNT_PATH || path.join(__dirname, '..', 'service-account-key.json');
let firestore = null;
